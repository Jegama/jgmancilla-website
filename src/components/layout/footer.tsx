    ...
    <footer className="bg-secondary text-secondary-foreground py-8 border-t">
      <div className="container-max flex flex-col md:flex-row items-center justify-between">
        <p className="text-sm mb-4 md:mb-0">
          &copy; {new Date().getFullYear()} Jesús Mancilla. All rights reserved.
        </p>
        <div className="flex space-x-4">
          <Link href="https://www.linkedin.com/in/jegama/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile" className="hover:text-accent transition-colors">
